...
struct TodoItem {
    ...
    init(id: String = UUID().uuidString, text: String, priority: Priority, deadline: Date? = nil, done: Bool = false, creationDate: Date = Date(), editDate: Date? = nil) {
        self.text = text
...
extension TodoItem {
    static let myItems = [
        TodoItem(id: UUID().uuidString, text: "i have to do this thing", priority: TodoItem.Priority.high, done: false, creationDate: Date.now),
        TodoItem(id: UUID().uuidString, text: "i have to do the other thing", priority: TodoItem.Priority.high, done: true, creationDate: Date.now),
    ]
}
